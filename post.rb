...
class Post
	...
	# 
	# Обратите внимание, что класс, объявленный с self. перед названием - это 
	...
	# ссылки на которые приведены в дополнительных материалах.
    # 
    # Метод create класса Post динамически (в зависимости от параметра) создаёт
    ...
    def read_from_console
    	# Этот метод, должен быть реализован у каждого ребёнка
    end
